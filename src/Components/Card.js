...
export const Card = () => {
  return (
    ...
    <div className="cardInside">
      ...
      <p>Dear One,</p>
      <p>
        Happy New Year 🥂 !! May this year will filled with lots of love,
        laughter and opportunities!  May your upcoming 365 days will be Fantastic.
      </p>
      <p className="name">Yours 
       😊</p>
